...
pub fn is_point_inside_rect(point: Vector2<i32>, x: i32, y: i32, width: i32, height: i32) -> bool {
    let point_x = point.x;
    let point_y = point.y;
...
// pub fn is_point_inside_rectangle(point: Vector2<i32>, rect: &Rectangle) -> bool {
